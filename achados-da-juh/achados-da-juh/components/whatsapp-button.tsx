...
export function WhatsappButton({
  ...
  return (
    <a
      ...
      onClick={trackLead}
      className={cn(
        "group inline-flex items-center justify-center gap-3 rounded-full bg-whatsapp font-semibold text-whatsapp-foreground shadow-lg shadow-whatsapp/30 transition-all hover:scale-[1.03] hover:shadow-xl hover:shadow-whatsapp/40 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-whatsapp/40 active:scale-95",
    ...
    >
      <WhatsappIcon
        className={cn(
          "shrink-0 transition-transform group-hover:rotate-6",
